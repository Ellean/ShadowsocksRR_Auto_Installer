...
#   Description:ShadowsocksRR Server Auto-Installer               #
#   Author: El_Paso <Younntone@gmail.com>                         #
...
echo
echo "#############################################################"
echo "#   ShadowsocksRR Server Auto-Installer                     #"
echo "#   System Required:  CentOS 6,7, Debian, Ubuntu            #"
echo "#   Author: El_Paso <Younntone@gmail.com>                   #"
...
pre_install(){
    ...
    echo "Please enter password for ShadowsocksRR:"
    read -p "(Default password: El_Paso):" shadowsockspwd
    [ -z "${shadowsockspwd}" ] && shadowsockspwd="El_Paso"
    echo
    echo "+-------------+"
    ...
    while true
    do
    echo -e "Please enter a port for ShadowsocksRR [1-65535]:"
...
install(){
    ...
    if [ -f /usr/local/shadowsocks/server.py ]; then
        ...
        echo "ShadowsocksRR install failed, please Email to El_Paso <Younntone@gmail.com> and contact"
        install_cleanup
        exit 1
    fi
}
